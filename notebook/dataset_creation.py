...
def get_info(path = '/home/INT/grimaldi.a/Documents/projets/WP3/2021-12-06_simulator_data/',
            patch_size = (16,16),
            max_duration = None,
            labelz = ['sea','gro'],
            sensor_size = (128, 128, 2),
    ...
    for train in [False,True]:
        dataset = Synthetic_Dataset(save_to=path, train=train, patch_size=patch_size, max_duration=max_duration)
